...
function LookupCustomers() {
  ...
  const handleSearch = (e: any) => {
    axios.get(DRIVER_LICENSE_API + e.target.value).then((res) => {
    ...
    <div>
      ...
      <div>
        ...
        <div className="px-4 py-4 sm:px-0">
          <div className="h-96 rounded-ls border-4 border-dashed border-gray-200">
            {/** table */}
...
export default LookupCustomers;
